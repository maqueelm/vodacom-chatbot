...
module.exports = {
  user          : process.env.NODE_ORACLEDB_USER || "ibmpoc",

  // Instead of hard coding the password, consider prompting for it,
  // passing it in an environment variable via process.env, or using
  // External Authentication.
  password      : process.env.NODE_ORACLEDB_PASSWORD || "IbmP0c",

  // For information on connection strings see:
  // https://github.com/oracle/node-oracledb/blob/master/doc/api.md#connectionstrings
  connectString : process.env.NODE_ORACLEDB_CONNECTIONSTRING || "10.132.33.221:1521/networks",

 // QA Remedy Connection
//  remedyUser      : process.env.NODE_ORACLEDB_USER || "pottiele",
//  remedyPassword  : process.env.NODE_ORACLEDB_PASSWORD ||"pottiele2018",
//  remedyConnectionString    :process.env.NODE_ORACLEDB_CONNECTIONSTRING || "10.132.27.158:1521/remqa.vodacom.corp",
 // QA Remedy Connection

 // Prod Remedy Connection
  remedyUser      : process.env.NODE_ORACLEDB_USER || "ibmwatson",
  remedyPassword  : process.env.NODE_ORACLEDB_PASSWORD ||"letmein123",
  remedyConnectionString    :process.env.NODE_ORACLEDB_CONNECTIONSTRING || "10.132.27.28:1521/rem_ro.vodacom.corp",
// Prod Remedy Connection
