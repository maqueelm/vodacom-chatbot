...
var ConversationPanel = (function () {
    ...
    textArray.forEach(function (currentText) {
      if (currentText) {
        ...
        var messageJson = {
          // <div class='segments'>
          'tagName': 'div',
          'classNames': ['segments', 'newline-dialog', 'col-xs-12', 'no-padding'],
          'children': [
            {
              // <div class='whatson-image-container'>
              'tagName': 'div',
              'classNames': [isUser ? 'user-image-container' : 'whatson-image-container'],
              'children': [{
                'tagName': 'span',
                       ...
                       
            {
              ...
              'children': [{
                ...
                'children': [{
                  // <p>{messageText}</p>
                  'tagName': 'p',
                  'text': currentText + "<br/><span class='timestamp'>"+calcTime()+"</span>"
                }]
              }]
            },
  ...
  function getDateTime() {
    ...
    function agentInputProgressBar(){
        ...
        $("#textInput").addClass("agent-waiting-msg");
        $("#textInput").attr("placeholder", "Agent is responding " ); 
    ...
    function calcTime() {
      ...
      //alert(nd.toLocaleString().split(",")[1]);
