	...
	conversation.message(payload, function (err, data) {
		try {
			fiber(function () {
				...
				if (data != null && data.intents[0] != null && data.intents[0].intent == "sites" && data.entities[0] != null && data.entities[0].entity != 'isolated_fault') {
					console.log("sites intent");
